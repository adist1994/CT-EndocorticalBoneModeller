/* 
 * File:   itkModelMetricBaseLocal.h
 * Author: rap58
 *
 * Created on 11 November 2014, 15:18
 */

#ifndef ITKMODELMETRICBASELOCAL_H
#define	ITKMODELMETRICBASELOCAL_H
...
namespace itk
{
    ...
    class SingleModelMetricBase:    public SingleValuedCostFunction
    {
    public:
        typedef SingleModelMetricBase Self;
        ...
        //------------ Superclass typedefs -----------//
        typedef Superclass::MeasureType MeasureType; // double in SingleValuedCostFunction
        ...
        itkTypeMacro(SingleModelMetricBase, Object);
    ...
    protected:
        ...
        SingleModelMetricBase();
        virtual ~SingleModelMetricBase() {}
        SingleModelMetricBase(const Self &) {}
...
#include "itkSingleModelMetricBaseLocal.hxx"
#endif

#endif	/* ITKMODELMETRICBASELOCAL_H */
