 ...
 *
 *=========================================================================*/
#ifndef itkQCTImageIO_h
#define itkQCTImageIO_h
 ...
 */
    ...
    class QCTImageIO:public ImageIOBase
    {
    public:
        /** Standard class typedefs. */
        typedef QCTImageIO           Self;
        ...
        itkTypeMacro(QCTImageIO, ImageIOBase);
    ...
    private:
        QCTImageIO(const Self &);     //purposely not implemented
    ...
    class QCTImageIOFactory:public ObjectFactoryBase
    {
    public:
        /** Standard class typedefs. */
        typedef QCTImageIOFactory< TPixel, VImageDimension > Self;
        ...
        {
            return "QCT ImageIO Factory, allows the loading of QCT images into insight";
        }
        ...
        /** Run-time type information (and related methods). */
        itkTypeMacro(QCTImageIOFactory, ObjectFactoryBase);
    ...
    protected:
        QCTImageIOFactory() {}
        ~QCTImageIOFactory() {}
        typedef QCTImageIO< TPixel, VImageDimension > myProductType;
        const myProductType *m_MyProduct;

    private:
        QCTImageIOFactory(const Self &); //purposely not implemented
        void operator=(const Self &);    //purposely not implemented
    };
} // namespace itk

#ifndef ITK_MANUAL_INSTANTIATION
#include "itkQCTImageIO.hxx"
#endif
